...
\author{Sipeng Xie$^\text{1}$, Qianhong Wu$^\text{1}$, Ruiqi Zhang$^\text{1}$, Minghang Li$^\text{1}$, and Bo Qin$^\text{2}$}

\affiliation{%
    $^\text{1}$Beihang University, Beijing, China \quad
    $^\text{2}$Renmin University of China, Beijing, China
}
\affiliation{\{sipengxie, qianhong.wu, ruiqizhang, liminghang\}@buaa.edu.cn}
