...
% Define new commands for procedure and function
\makeatletter
\newcommand{\PROCEDURE}[2]{\ALC@it\algorithmicprocedure\ \textsc{#1}(#2)}
\newcommand{\ENDPROCEDURE}{\ALC@it\algorithmicend\ \algorithmicprocedure}
\newcommand{\FUNCTION}[2]{\ALC@it\algorithmicfunction\ \textsc{#1}(#2)}
\newcommand{\ENDFUNCTION}{\ALC@it\algorithmicend\ \algorithmicfunction}
\makeatother
