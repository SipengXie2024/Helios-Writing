...
\usepackage{amsthm}
\usepackage{microtype} % 启用微排版优化
\usepackage{subcaption}
\usepackage{booktabs}
\usepackage{threeparttable}
\usepackage{enumitem}
\renewcommand{\arraystretch}{1.2} % Optimize row height for booktabs
...
\author{Sipeng Xie$^\text{1}$, Ruiqi Zhang$^\text{1}$, Minghang Li$^\text{1}$, Qianhong Wu$^\text{1}$, and Bo Qin$^\text{2}$}

\affiliation{%
    $^\text{1}$Beihang University, Beijing, China \quad
    $^\text{2}$Renmin University of China, Beijing, China
}
\affiliation{\{sipengxie, ruiqizhang, minghangli, qianhong.wu\}@buaa.edu.cn}
...
\input{chapters/background-motivation.tex}
