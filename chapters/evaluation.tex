...
\include{table/optimization-overhead}
...
\include{figures/micro-bench-exec}
\include{table/geth-vs-revm}
...
\include{table/opcode-reduction}
...
\include{figures/storage-growth}
...
\include{table/storage-coverage-tradeoff}
...
\include{figures/replay-speed-up}
...
\include{figures/online-no-filter}
...
\include{figures/online-filtered}
